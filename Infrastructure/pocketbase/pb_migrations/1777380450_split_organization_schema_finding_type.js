migrate(
  (app) => {
    ...
    try {
      ...
      findingType.set("key", "missing-organization-schema");
    }

    findingType.set("label", "Missing Organization Schema");
    findingType.set("sort_order", 7);
    ...
    template.set("match_pattern", "Missing Organization Schema");
